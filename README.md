...
<ul>
  ...
  <li>
    ...
    <ul>
      <li>
        <a href="#создание-чека-коррекции-ффд1.05">Создание чека коррекции ФФД1.05</a>
        <ul>
          <li><a href="#добавление-вендинга-в-чек-коррекции">Добавление вендинга в чек коррекции</a></li>
        </ul>
      </li>
      <li><a href="#отправка-чека-коррекции-ффд1.2">Отправка чека коррекции ФФД1.2</a></li>
      <li>
        <a href="#создание-чека-коррекции-ффд1.2">Создание чека коррекции ФФД1.2</a>
      </li>
      <li><a href="#отправка-чека-коррекции-ффд1.2">Отправка чека коррекции ФФД1.2</a></li>
